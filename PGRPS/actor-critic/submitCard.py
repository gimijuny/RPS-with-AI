...
if sys.argv[1] != None:
	playerId = sys.argv[0]
if sys.argv[2] != None:
	player_previous = int(sys.argv[2])
if sys.argv[3] != "null":
	ai_previous = int(sys.argv[3])
else:
    ai_previous = None
if sys.argv[4] != "null":
	player_card = int(sys.argv[4])
else:
    player_card = None
if sys.argv[5] != None:
	player_score = int(sys.argv[5])
if sys.argv[6] != None:
	ai_score = int(sys.argv[6])
